...
Built with Flask (backend:"https://placement-prediction-1-fsqk.onrender.com/predict" ) and Streamlit (frontend:https://placementprediction-j4te9uvnz5dsz7a7idprus.streamlit.app/ ) using a Logistic Regression model.
